(function (app) {
    ...
    createCtrl.$inject = ['$scope', '$http', 'apiService', 'membershipService', 'webApiLocationService', 'notificationService', '$stateParams'];


    function createCtrl ($scope, $http, apiService, membershipService, webApiLocationService, notificationService, $stateParams) {
        $scope.quizName = 'data/emptyQuiz.js';
